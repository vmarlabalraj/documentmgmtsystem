...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <body>
		<header>
			...
			<div class="header-title" style="display:block;padding-left:410px;">Document Management Module</div>
		...
		<footer class="login-footer">
			<div class="container-fluid">
				<span class="copyright">&copy; <c:out value="${copyRight}"></c:out></span>
			</div>
		</footer>
    </body>
</html>