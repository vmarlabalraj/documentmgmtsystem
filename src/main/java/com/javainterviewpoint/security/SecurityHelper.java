...
public class SecurityHelper {
	...
	public static boolean hasRole(String role) {
		...
		if (userDetails != null) {
			...
			if (isRolePresent(authorities, role)) hasRole = true;
		}
		return hasRole;
	}
	 ...
	 */
	private static boolean isRolePresent(Collection<? extends GrantedAuthority> authorities, String role) {
	...
	public static boolean hasAccess(String featureId) {
		...
		if (userDetails != null) {
			...
			Map<String, String> featuresMap = (Map<String, String>) RequestContextHolder.getRequestAttributes().getAttribute("features", 0);
			
			if(featuresMap==null)
				featuresMap = (Map<String, String>) session.getAttribute("userRoleFeatures");
